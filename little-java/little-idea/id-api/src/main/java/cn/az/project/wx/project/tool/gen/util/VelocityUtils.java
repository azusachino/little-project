...
public class VelocityUtils {
    ...
    public static HashSet<String> getImportList(List<GenTableColumn> columns) {
        ...
        for (GenTableColumn column : columns) {
            ...
            } else if (!column.isSuperColumn() && GenerateConstants.TYPE_BIG_DECIMAL.equals(column.getJavaType())) {
    ...
    public static String getTreecode(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenerateConstants.TREE_CODE)) {
            return StringUtil.toCamelCase(paramsObj.getString(GenerateConstants.TREE_CODE));
        }
        return "";
    }
    ...
    public static String getTreeParentCode(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenerateConstants.TREE_PARENT_CODE)) {
            return StringUtil.toCamelCase(paramsObj.getString(GenerateConstants.TREE_PARENT_CODE));
        }
        return "";
    }
    ...
    public static String getTreeName(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenerateConstants.TREE_NAME)) {
            return StringUtil.toCamelCase(paramsObj.getString(GenerateConstants.TREE_NAME));
        }
        return "";
    }
