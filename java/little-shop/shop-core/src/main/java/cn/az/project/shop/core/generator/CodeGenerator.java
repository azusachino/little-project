package cn.az.project.shop.core.generator;
...
public class CodeGenerator {
    ...
    private static final String URL = "jdbc:mysql://180.76.169.35:3306/little_shop?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "azusa520";
    private static final String AUTHOR = "Liz";
    private static final String BASE_PACKAGE_URL = "cn.az.shop.db";
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/shop-db";
