package cn.az.project.test.common.handler;
...
public class CommonExceptionHandler {
    ...
    public RestResponse handleException(Exception e) {
        ...
        return RestResponse.init().code(HttpStatus.INTERNAL_SERVER_ERROR).message("系统内部异常");
    }
    ...
    public RestResponse handleParamsInvalidException(CommonException e) {
        ...
        return RestResponse.init().code(HttpStatus.INTERNAL_SERVER_ERROR).message(e.getMessage());
    }
    ...
    public RestResponse validExceptionHandler(BindException e) {
        ...
        return RestResponse.init().code(HttpStatus.BAD_REQUEST).message(message.toString());
    ...
    public RestResponse handleConstraintViolationException(ConstraintViolationException e) {
        ...
        message = new StringBuilder(message.substring(0, message.length() - 1));
        return RestResponse.init().code(HttpStatus.BAD_GATEWAY).message(message.toString());
    }
    ...
    public RestResponse handleLimitAccessException(LimitAccessException e) {
        ...
        return RestResponse.init().code(HttpStatus.TOO_MANY_REQUESTS).message(e.getMessage());
    }
    ...
    public RestResponse handleUnauthorizedException(Exception e) {
        ...
        return RestResponse.init().code(HttpStatus.FORBIDDEN).message(e.getMessage());
    }
}
