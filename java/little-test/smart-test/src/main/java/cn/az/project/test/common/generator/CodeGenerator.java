package cn.az.project.test.common.generator;
...
public class CodeGenerator {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/smart_test_dev?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "azusa520";
    private static final String AUTHOR = "Liz";
    private static final String BASE_PACKAGE_URL = "cn.az.test";
