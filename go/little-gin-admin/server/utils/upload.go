...
func Upload(file *multipart.FileHeader) (err error, path string, key string) {
	putPolicy := storage.PutPolicy{
		Scope: global.ServerConfig.Qiniu.Bucket,
	}
	...
	if err != nil {
		global.Logger.Error("upload file fail:", err)
		return err, "", ""
	}
	return err, global.ServerConfig.Qiniu.ImgPath + "/" + ret.Key, ret.Key
}
...
func DeleteFile(key string) error {
	...
	err := bucketManager.Delete(global.ServerConfig.Qiniu.Bucket, key)
	if err != nil {
		fmt.Println(err)
		return err
	}
