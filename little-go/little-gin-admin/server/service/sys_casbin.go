...
func UpdateCasbinApi(oldPath string, newPath string, oldMethod string, newMethod string) error {
	...
	err := global.DB.Table("casbin_rule").Where("v1 = ? AND v2 = ?", oldPath, oldMethod).Find(&cs).Updates(map[string]string{
		"v1": newPath,
		"v2": newMethod,
	}).Error
	return err
...
func Casbin() *casbin.Enforcer {
	...
	e := casbin.NewEnforcer(global.ServerConfig.Casbin.ModelPath, a)
